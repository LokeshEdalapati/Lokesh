"""chronic_diseases_prediction URL Configuration
...
from chronic_diseases_prediction import settings
...
urlpatterns = [
    ...
    url(r'^Prediction_Of_Chronic_Diseases_Type/$', remoteuser.Prediction_Of_Chronic_Diseases_Type, name="Prediction_Of_Chronic_Diseases_Type"),
    ...
    url(r'^View_Prediction_Of_Chronic_Diseases_Type_Ratio/$', serviceprovider.View_Prediction_Of_Chronic_Diseases_Type_Ratio, name="View_Prediction_Of_Chronic_Diseases_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Chronic_Diseases_Type_Details/$', serviceprovider.View_Prediction_Of_Chronic_Diseases_Type_Details, name="View_Prediction_Of_Chronic_Diseases_Type_Details"),
