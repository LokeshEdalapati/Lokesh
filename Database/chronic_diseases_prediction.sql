...
--
-- Database: `chronic_diseases_prediction`
--
CREATE DATABASE IF NOT EXISTS `chronic_diseases_prediction` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `chronic_diseases_prediction`;
...
('4lfd2fphyxzeqj04s3tjd2mc7do6vtd7', 'eyJ1c2VyaWQiOjd9:1stqR7:uJjZrPx_Ed3ikahlBAgO5Tn5JHPt7zSC4xxTuh6CNfA', '2024-10-10 15:29:45.460509'),
...
('md2i05acx7ui5dvewj7d21ttu4e8rjxb', 'eyJ1c2VyaWQiOjN9:1qOGTQ:koHnhTnPn1G8L9ln4dbeQwhFQxvTxMg4m2WJmiPWWuc', '2023-08-08 11:45:05.012634'),
...
('zqozwm7t364a3sflmacph54muy0ygu71', 'eyJ1c2VyaWQiOjR9:1qOISh:3SOVvyNUhjNB-WPTgy53sFtmdWvjEDZf4U-syh2WmZg', '2023-08-08 13:52:27.834494');
...
(5, 'Gopinath', 'Gopinath123@gmail.com', 'Gopinath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,8th Cross,Malleshwaram', 'Male'),
(6, 'Manjunath', 'tmksmanju14@gmail.com', 'Manjunath', '9535866270', 'India', 'karnataka', 'Bangalore', '#8928,8th Cross,Malleshwaram', 'Male'),
(7, 'tmksmanju', 'tmksmanju14@gmail.com', 'tmksmanju', '9535866270', 'India', 'karnataka', 'Bangalore', '#8928,10th Cross,Malleshwaram', 'Male');
...
(33, 'Multi-Layer Perceptron Classifier', '55.072463768115945'),
(34, 'SVM', '50.72463768115942'),
(35, 'Logistic Regression', '48.188405797101446'),
(36, 'Decision Tree Classifier', '51.81159420289855');
...
(10, 'Kidney Disease', '50.0'),
(11, 'Diabetic', '50.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_predict_chronic_diseases`
--

CREATE TABLE IF NOT EXISTS `remote_user_predict_chronic_diseases` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `Smoking` varchar(300) NOT NULL,
  `Diabetic` varchar(300) NOT NULL,
  `KidneyDisease` varchar(300) NOT NULL,
  `marital_status` varchar(300) NOT NULL,
  `highest_qualification` varchar(300) NOT NULL,
...
--
-- Dumping data for table `remote_user_predict_chronic_diseases`
--

INSERT INTO `remote_user_predict_chronic_diseases` (`id`, `Fid`, `Gender`, `Age`, `ADDRESS`, `CITY`, `Smoking`, `Diabetic`, `KidneyDisease`, `marital_status`, `highest_qualification`, `children`, `Prediction`) VALUES
(1, '172.217.10.68-10.42.0.151-443-36297-6', 'Female', '40', '94 OLD STATE RD', 'BROOKFIELD', 'No', '1', '0', 'Married', 'Degree', '0', 'Diabetic'),
(2, '10.42.0.211-63.250.200.101-58455-443-6', 'Female', '39', '45 GLENVILLE RD', 'GREENWICH', 'No', '0', '1', 'Married', 'GCSE/O Level', '0', 'Kidney Disease'),
(3, '10.42.0.211-106.11.15.99-49719-443-6', 'Female', '37', '660 MOREHOUSE RD', 'EASTON', 'Yes', '1', '0', 'Married', 'GCSE/O Level', '0', 'Diabetic'),
(4, '10.42.0.211-95.213.11.133-54063-443-6', 'Male', '35', '51 N CLIFF ST', 'ANSONIA', 'Yes', '1', '0', 'Separated', 'GCSE/O Level', '1', 'Diabetic'),
(5, '10.42.0.211-119.167.164.34-41935-80-6', 'Female', '60', '989 NEW HAVEN AVE', 'MILFORD', 'Yes', '0', '1', 'Married', 'No Qualification', '0', 'Kidney Disease'),
(6, '10.42.0.211-10.42.0.1-29729-53-17', 'Female', '32', '208 COLUMBUS AVE', 'NEW HAVEN', 'Yes', '0', '1', 'Married', 'GCSE/CSE', '3', 'Kidney Disease');
